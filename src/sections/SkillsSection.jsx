...
const skills = [
  ...
  { name: 'TypeScript', icon: '📘', level: 85, color: '#3178c6', category: 'Core' },
  { name: 'React', icon: '⚛️', level: 85, color: '#61dafb', category: 'Framework' },
  { name: 'Angular', icon: '🅰️', level: 80, color: '#dd0031', category: 'Framework' },
  { name: 'Tailwind CSS', icon: '💨', level: 82, color: '#38bdf8', category: 'Framework' },
  { name: 'AI Dev Tools', icon: '🤖', level: 88, color: '#10a37f', category: 'Tools' },
